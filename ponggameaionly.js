 //Variables that can be referenced in many functions
    ...
    //}
      //AI movement on the left side
    var paddle1YCenter = paddle1Y + (PADDLE_HEIGHT/2);
      if (paddle1YCenter < ballY-35 && ballX < canvas.width/1.5){
        paddle1Y += 6;
      } else if (paddle1YCenter > ballY+35 && ballX < canvas.width/1.5){
        paddle1Y -= 6;
      }
    }
